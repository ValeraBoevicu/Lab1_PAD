...
class CommunicationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessage = channel.unary_unary(
                '/myapp.CommunicationService/SendMessage',
...
def add_CommunicationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'myapp.CommunicationService', rpc_method_handlers)
...
class CommunicationService(object):
    ...
    def SendMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/myapp.CommunicationService/SendMessage',
            communication__pb2.Message.SerializeToString,
